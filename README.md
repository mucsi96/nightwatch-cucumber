...
| `--output` |	`-o` | :no_entry:         |                      |	tests_output	The location where the JUnit XML reports will be saved.                                                                                 |
| `--reporter` | `-r` |	:no_entry: | junit |	Name of a predefined reporter (e.g. junit) or path to a custom reporter file to use. |
