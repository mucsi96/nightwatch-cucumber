...
module.exports = function (providedOptions) {
  ...
  peerTest('nightwatch', {
    '^0.9.1': notTested.bind(null, '0.8.0 - 0.9.0'),
    '0.8.0 - 0.9.0': supported,
    other: notSuppoted.bind(null, '0.8.0 - 0.9.0'),
    notFound: notFound
  })
  peerTest('cucumber', {
    '^0.10.4': notTested.bind(null, '0.9.5 - 0.10.3'),
    '0.9.5 - 0.10.3': supported,
    other: notSuppoted.bind(null, '0.9.5 - 0.10.3'),
    notFound: notFound
  })
