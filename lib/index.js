...
module.exports = function (providedOptions) {
  ...
  peerUtils.checkDependency('nightwatch', {
    '^0.9.16': notTested.bind(null, '0.8.0 - 0.9.15'),
    '0.8.0 - 0.9.15': supported,
    other: notSuppoted.bind(null, '0.8.0 - 0.9.15'),
    notFound: notFound
  })
  peerUtils.checkDependency('cucumber', {
    '^2.1.1': notTested.bind(null, '2.0.0 - 2.1.0'),
    '2.0.0 - 2.1.0': supported,
    other: notSuppoted.bind(null, '2.0.0 - 2.1.0'),
    notFound: notFound
  })
