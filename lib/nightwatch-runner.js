...
function patchNighwatchReporter (globalResults, testResults, globalStartTime, options) {
...
function patchCucumberFormatters () {
  formatters.forEach(function (formatter) {
    var origLog = formatter.log

    formatter.log = function (string) {
      var self = this
      var lines = string.split('\n')
      lines.forEach(function (line) {
        origLog.call(self, line)
      })
    }
  })
}
