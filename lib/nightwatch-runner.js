...
function discoverScenario(feature, scenario, steps, options) {
    ...
    if (!feature.discovered) {
        ...
        options.beforeScenario && feature.discovered.beforeEach = options.beforeScenario;
        options.afterScenario && feature.discovered.afterEach = options.afterScenario;
