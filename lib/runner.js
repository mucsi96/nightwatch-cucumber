...
module.exports = class Runner {
  ...
  * executeTestModules (dummyTestModules) {
    ...
    yield * this.cucumberApi.run(this.options.jsonReport)
  ...
  run (options) {
    ...
    this.nightwatchApi = new NightwatchApi()
    ...
    this.cucumberApi.addStepFailureHook(function * (attach, feature, scenario) {
      const screenshot = yield * self.nightwatchApi.takeScreenshot(feature, scenario)
      yield * attach(screenshot.data, screenshot.mimeType)
    })
