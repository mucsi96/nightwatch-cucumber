...
module.exports = class Runner {
  ...
  * executeTestModules (dummyTestModules) {
    ...
    const tags = findResult(this.nightwatchApi.nightwatchArgv.tags, false)
    const skipTags = findResult(this.nightwatchApi.nightwatchArgv.skiptags, true)

    this.options.tags = tags && skipTags ? `${tags} and ${skipTags}` : `${tags}${skipTags}`
