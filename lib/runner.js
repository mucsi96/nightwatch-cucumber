...
module.exports = class Runner {
    ...
    featurePathToDummyPath(sourceFeatureFile) {
        let featureFile = sourceFeatureFile;
    ...
    dummyPathToFeaturePath(sourceDummyPath) {
        let dummyPath = sourceDummyPath;

        if (!dummyPath.match(/\.js$/)) {
            dummyPath += ".js";
        }
