...
module.exports = class NightwatchApi {
  ...
  * executeInNightwatchContext (fn, args, asynchronous) {
    yield new Promise((resolve, reject) => {
        ...
        try {
          ...
          if (asynchronous) {
            fn.apply(new Proxy({}, {
              get (target, name) {
                return function () {
                  const error = new Error('Nightwatch API is disabled as you provided a callback function. You cannot use both!')
