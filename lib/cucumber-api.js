...
module.exports = class CucumberAPI {
  ...
  * handleAttachments (testCase, stepResult, attach) {
  ...
  injectTimeoutHandler () {
    const originalUserCodeRunnerRun = Cucumber.UserCodeRunner.prototype.run
    Cucumber.UserCodeRunner.prototype.run = function (props) {
      props.timeoutInMilliseconds = 0
