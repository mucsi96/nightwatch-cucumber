...
describe("BDD handling", () => {
    ...
    it("should handle background steps", () => {
        return testCaseFactory
            ...
            .scenario("small numbers")
            .given("User enter 5 in B field", function() {
                this.setValue("#b", 5);
            })
            .when("User press Add button", function() {
                this.click("#add");
            ...
            .scenario("big numbers")
            .and("User enter 6 in B field", function() {
                this.setValue("#b", 6);
            })
            .when("User press Add button")
            .then("The result should contain 10", function() {
                this.assert.containsText("#result", 10);
            })
            .run()
            .then((result) => {
                result.features[0].result.status.should.be.passed;
    ...
    it("should handle scenario outlines", () => {
        return testCaseFactory
            ...
            .and("User enter <a> in A field", function(a) {
                this.setValue("#a", a);
            })
            .and("User enter <b> in B field", function(b) {
                this.setValue("#b", b);
            })
            .when("User press Add button", function() {
                this.click("#add");
            })
            .then("The result should contain <result>", function(result) {
                this.assert.containsText("#result", result);
            })
            .example("a", "b", "result")
            .example("1", "1", "2")
            .example("78", "22", "100")
