...
describe("Error handling", () => {
    ...
    it("should handle pending steps", () => {
        return testCaseFactory
            ...
            .and("User enter 4 in A field", function(callback) {
    ...
    it("should handle failed steps", () => {
        return testCaseFactory
            ...
            .and("User enter 82 in A field", function() {
                this.setValue("#a", 82);
            })
            .and("User enter 11 in B field", function() {
                this.setValue("#b", 11);
            })
            .when("User press Add button")
            .then("The result should contain 93", function() {
                this.assert.containsText("#result", 93);
            })
            .run()
            .then((result) => {
                result.features[0].result.status.should.be.failed;
    ...
    it("should handle JS error in step definition", () => {
        return testCaseFactory
            ...
            .feature("addition")
            .scenario("small numbers")
            .given("User is on the simple calculator page. JS error included", function() {
                this.initte();
            })
            .and("User enter 4 in A field", function() {
                this.setValue("#a", 4);
    ...
    it("should handle errors in custom commands", () => {
        return testCaseFactory
            ...
            .and("User enter 5 in B field", function() {
                this.page.calculator().setValue("@numberB", 5);
            })
            .when("User press Add button", function() {
                this.page.calculator().click("@addButton");
            })
            .then("The result should contain 9", function() {
                this.page.calculator().assert.containsText("@result", 9);
            })
            .run()
            .then((result) => {
                result.features[0].result.status.should.be.failed;
