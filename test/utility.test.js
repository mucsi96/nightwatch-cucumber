...
describe("Utility features", () => {
    ...
    it("should handle page objects", () => {
        return testCaseFactory
            ...
            .and("User enter 4 in A field", function() {
                this.page.calculator().setValue("@numberA", 4);
            })
            .and("User enter 5 in B field", function() {
    ...
    it("should be able to provide Nightwatch client as step definition first parameter", () => {
      ...
      .and("User enter \"4\" in A field", (client, a) => {
          client.setValue("#a", a);
      })
      .and("User enter \"5\" in B field", (client, b) => {
          client.setValue("#b", b);
      })
      .when("User press Add button", (client) => {
          client.click("#add");
      })
      .then("The result should contain \"9\"", (client, result) => {
          client.assert.containsText("#result", result);
      })
      .scenario("big numbers")
      .given("User is on the simple calculator page")
